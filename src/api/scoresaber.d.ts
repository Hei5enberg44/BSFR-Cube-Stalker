export interface components {
    schemas: {
        Metadata: { total: number; page: number; itemsPerPage: number }
        LeaderboardInfo: {
            id: number
            songHash: string
            songName: string
        ...
        Badge: { description: string; image: string }
        ...
        RankingDifficulty: { requestId: number; difficulty: number }
        Comment: {
            username: string
            userId: string
            comment: string
        ...
        UserData: { playerId: string; permissions: number; questKey: string }
    }
}
